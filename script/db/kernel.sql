...
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='部门管理';
...
) ENGINE=InnoDB AUTO_INCREMENT=18 DEFAULT CHARSET=utf8mb4 COMMENT='字典表';
...
CREATE TABLE `sys_dict_item` (
  ...
  KEY `sys_dict_del_flag` (`del_flag`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=56 DEFAULT CHARSET=utf8mb4 COMMENT='字典项';
...
CREATE TABLE `sys_file` (
  ...
  `create_user` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
...
) ENGINE=InnoDB AUTO_INCREMENT=10009 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='菜单权限表';
...
-- ----------------------------
BEGIN;
INSERT INTO `sys_oauth_client_details` VALUES ('app', NULL, 'app', 'server', 'password,refresh_token,authorization_code,client_credentials,implicit', NULL, NULL, 43200, 2592000, NULL, 'true', 1);
...
INSERT INTO `sys_oauth_client_details` VALUES ('zcloud', NULL, 'zcloud', 'server', 'password,refresh_token,authorization_code,client_credentials', 'http://localhost:4040/sso1/login,http://localhost:4041/sso1/login', NULL, NULL, NULL, NULL, 'true', 1);
...
CREATE TABLE `sys_role` (
  ...
  `ds_type` char(1) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT '0',
  `ds_scope` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `sys_route_conf` (
  ...
  `route_name` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  ...
  `del_flag` char(1) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT '0',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='路由配置表';

-- ----------------------------
-- Records of sys_route_conf
-- ----------------------------
BEGIN;
INSERT INTO `sys_route_conf` VALUES (1, '工作流管理模块', 'kernel-activiti', '[{\"args\": {\"_genkey_0\": \"/act/**\"}, \"name\": \"Path\"}]', '[]', 'lb://kernel-activiti', 0, '2019-08-17 07:53:17', '2019-08-27 09:38:37', '0');
INSERT INTO `sys_route_conf` VALUES (2, '认证中心', 'kernel-auth', '[{\"args\": {\"_genkey_0\": \"/auth/**\"}, \"name\": \"Path\"}]', '[{\"args\": {}, \"name\": \"ValidateCodeGatewayFilter\"}, {\"args\": {}, \"name\": \"PasswordDecoderFilter\"}]', 'lb://kernel-auth', 0, '2019-08-17 07:53:17', '2019-08-27 09:38:38', '0');
INSERT INTO `sys_route_conf` VALUES (3, '代码生成模块', 'kernel-codegen', '[{\"args\": {\"_genkey_0\": \"/gen/**\"}, \"name\": \"Path\"}]', '[]', 'lb://kernel-codegen', 0, '2019-08-17 07:53:17', '2019-08-27 09:38:39', '0');
INSERT INTO `sys_route_conf` VALUES (4, 'elastic-job定时任务模块', 'kernel-daemon-elastic-job', '[{\"args\": {\"_genkey_0\": \"/daemon/**\"}, \"name\": \"Path\"}]', '[]', 'lb://kernel-daemon-elastic-job', 0, '2019-08-17 07:53:17', '2019-08-27 09:38:40', '0');
INSERT INTO `sys_route_conf` VALUES (5, 'quartz定时任务模块', 'kernel-daemon-quartz', '[{\"args\": {\"_genkey_0\": \"/job/**\"}, \"name\": \"Path\"}]', '[]', 'lb://kernel-daemon-quartz', 0, '2019-08-17 07:53:17', '2019-08-27 09:38:42', '0');
INSERT INTO `sys_route_conf` VALUES (6, '分布式事务模块', 'kernel-tx-manager', '[{\"args\": {\"_genkey_0\": \"/tx/**\"}, \"name\": \"Path\"}]', '[]', 'lb://kernel-tx-manager', 0, '2019-08-17 07:53:17', '2019-08-27 09:38:43', '0');
INSERT INTO `sys_route_conf` VALUES (7, '通用权限模块', 'kernel-upms-biz', '[{\"args\": {\"_genkey_0\": \"/admin/**\"}, \"name\": \"Path\"}]', '[{\"args\": {\"key-resolver\": \"#{@remoteAddrKeyResolver}\", \"redis-rate-limiter.burstCapacity\": \"20\", \"redis-rate-limiter.replenishRate\": \"10\"}, \"name\": \"RequestRateLimiter\"}, {\"args\": {\"name\": \"default\", \"fallbackUri\": \"forward:/fallback\"}, \"name\": \"Hystrix\"}]', 'lb://kernel-upms-biz', 0, '2019-08-17 07:53:17', '2019-08-27 09:38:44', '0');
INSERT INTO `sys_route_conf` VALUES (8, '工作流长链接支持1', 'kernel-activiti-ws-1', '[{\"args\": {\"_genkey_0\": \"/act/ws/info/**\"}, \"name\": \"Path\"}]', '[]', 'lb://kernel-activiti', 0, '2019-08-17 07:53:17', '2019-08-27 09:38:45', '0');
INSERT INTO `sys_route_conf` VALUES (9, '工作流长链接支持2', 'kernel-activiti-ws-2', '[{\"args\": {\"_genkey_0\": \"/act/ws/**\"}, \"name\": \"Path\"}]', '[]', 'lb:ws://kernel-activiti', 100, '2019-08-17 07:53:17', '2019-08-27 09:38:46', '0');
INSERT INTO `sys_route_conf` VALUES (10, '微信公众号管理', 'kernel-mp-manager', '[{\"args\": {\"_genkey_0\": \"/mp/**\"}, \"name\": \"Path\"}]', '[]', 'lb://kernel-mp-manager', 0, '2019-08-17 07:53:17', '2019-08-27 09:38:49', '0');
INSERT INTO `sys_route_conf` VALUES (11, '支付管理', 'kernel-pay', '[{\"args\": {\"_genkey_0\": \"/pay/**\"}, \"name\": \"Path\"}]', '[]', 'lb://kernel-pay', 0, '2019-08-17 07:53:17', '2019-08-27 09:38:50', '0');
INSERT INTO `sys_route_conf` VALUES (12, '监控管理', 'kernel-monitor', '[{\"args\": {\"_genkey_0\": \"/monitor/**\"}, \"name\": \"Path\"}]', '[]', 'lb://kernel-monitor', 0, '2019-08-17 07:53:17', '2019-08-27 09:38:51', '0');
COMMIT;
...
CREATE TABLE `sys_social_details` (
  ...
  `tenant_id` int(11) NOT NULL DEFAULT '0' COMMENT '所属租户',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='系统社交登录账号表';
...
CREATE TABLE `sys_user` (
  ...
  `create_time` timestamp NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `update_time` timestamp NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
  `lock_flag` char(1) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT '0',
  `del_flag` char(1) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT '0',
  `wx_openid` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `qq_openid` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `gitee_login` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `osc_id` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `tenant_id` int(11) NOT NULL DEFAULT '0' COMMENT '所属租户',
...
-- ----------------------------
BEGIN;
INSERT INTO `sys_user` VALUES (1, 'admin', '$2a$10$QOfWxxFyAMmEEmnuw9UI/..1s4B4eF/u9PzE2ZaGO.ij9YfmcUy.u', '', '17034642888', 'lengleng-52328736c020449b8c18a474b5689d5b.jpg', 1, '2018-04-20 07:15:18', '2019-08-22 11:55:29', '0', '0', 'o_0FT0uyg_H1vVy2H0JpSwlVGhWQ', NULL, 'log4j', '2303656', 1);
COMMIT;
